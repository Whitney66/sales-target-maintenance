...
function createFormLine(data = {}, canRemove = false) {
  ...
  return `<div class="add-row" data-form-line>
    ...
    <label class="form-field"><strong><i>*</i>员工姓名 / 工号</strong><div class="employee-combobox"><input data-field="employeeText" list="eopEmployeeOptions" autocomplete="off" placeholder="搜索或选择员工" value="${escapeHtml(employeeText)}" /></div><small><b>校验规则：</b>必填，单选，取自EOP，展示为“姓名 / 8位工号”。</small></label>
